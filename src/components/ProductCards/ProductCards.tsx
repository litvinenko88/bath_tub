      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 sm:gap-8">
          {products.map((product, index) => (
            <div 
              key={index} 
              className="group relative mb-16 sm:mb-20"
              style={{ animationDelay: `${index * 200}ms` }}
            >
              {/* Основная карточка */}
              <div className="bg-white rounded-lg shadow-lg border border-gray-100 font-mono text-left overflow-hidden transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl animate-fade-in-up">
              ...
              {/* Выпадающая кнопка */}
              <div className="absolute -bottom-6 left-4 right-4 transform translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out z-10">
